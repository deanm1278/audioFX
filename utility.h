...
extern void _fm_modulate(q28 t, q31 *buf, q16 *cFreq, q31 *mod, q31 *vol, q31 gain);
extern void _fm_modulate_feedback(q28 t, q31 *buf, q16 *cFreq, q31 *volume_buf, q31 gain, q31 feedbackLevel, q31 *lastFeedback);
};
